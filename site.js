(() => {
  ...
  const caseUpdates = [
    ...
    {
      title: 'Wanda Line',
      status: 'Final coroner findings · homicide by blunt-force head trauma · evidence custody inquiry open',
      focus: 'Franklin County Coroner case C84-25 resolves the injury discrepancy. The final February 29, 1984 supplemental certification classifies Wanda\'s death as homicide and attributes it to blunt impacts to the head with skull fractures and brain contusions. The report says the victim was allegedly beaten. The earlier “apparent gunshot” notation was a preliminary scene or intake impression, not the final medical finding. The autopsy also documents blunt impacts to the trunk and extremities. A vaginal swab contained sperm; oral and rectal swabs were negative. That finding alone does not establish sexual assault or identify an assailant. The packet\'s only toxicology result is a tranquilizer, sedative, and hypnotics analysis in which no agents were detected. The next inquiry is whether the documented swab, slides, or related biological specimens still exist and where custody transferred if they do not remain with the Coroner.'
    },
    {
  ...
  caseUpdates.forEach((update) => {
    ...
    if (update.title === 'Wanda Line') {
      if (!card.querySelector('.coroner-report-note')) {
        card.insertAdjacentHTML('beforeend', '<p class="case-note coroner-report-note">Primary medical source: Franklin County Coroner case C84-25, including the final supplemental medical certification, autopsy report, and toxicology analysis. Received directly from the Coroner’s Office on August 12, 2026. The raw scans are preserved privately and are not republished because they contain personal identifiers and sensitive autopsy detail.</p>');
      }
      ...
      appendLinkOnce(card, 'Ohio Attorney General cold-case page', '<br><a href="https://www.ohioattorneygeneral.gov/Files/Law-Enforcement/Investigator/Cold-Case/Homicides/Line" target="_blank" rel="noreferrer">Ohio Attorney General cold-case page ↗</a>');
  ...
  if (ledgerGrid) {
    if (!Array.from(ledgerGrid.querySelectorAll('h3')).some((heading) => heading.textContent.trim() === 'Walter A. Mosier')) {
      ledgerGrid.insertAdjacentHTML('afterbegin', '<article class="case-card"><div class="case-topline"><span>21</span><span class="status waiting">Current forensic work · no usable DNA produced yet</span></div><p class="case-place">Seneca / Sullivan, Missouri · Missing 2006 · Remains recovered 2007</p><h3>Walter A. Mosier</h3><p class="case-focus">The FBI’s July 2026 ViCAP alert says Walter disappeared from Seneca on September 15, 2006. His skeletal remains were recovered near Interstate 44 and the Flying J Travel Center in Sullivan on March 15, 2007. The medical examiner attributed his death to homicidal violence, including blunt craniocerebral trauma and blunt and sharp trauma of the neck and chest. On August 14, 2026, Captain Charles W. Subke told Open Case Ledger that no usable DNA had been produced yet and that he was still submitting evidence. The response does not establish that all evidence has been exhausted or that future testing is impossible; it confirms that the forensic-evidence process remains active.</p><a href="cases/walter-a-mosier.html">Open the Walter A. Mosier case page ↗</a><br><a href="https://www.fbi.gov/wanted/vicap/homicides-and-sexual-assaults/walter-a-mosier---seneca-missouri/mosier.pdf" target="_blank" rel="noreferrer">FBI ViCAP official alert ↗</a></article>');
    }

    if (!Array.from(ledgerGrid.querySelectorAll('h3')).some((heading) => heading.textContent.trim() === 'Nicoleta Hamlett')) {
      ledgerGrid.insertAdjacentHTML('afterbegin', '<article class="case-card"><div class="case-topline"><span>20</span><span class="status waiting">ME report received · manner undetermined · property sheet pending</span></div><p class="case-place">Queen Valley, Arizona · 2024</p><h3>Nicoleta Hamlett</h3><p class="case-focus">Pinal County Medical Examiner report 24-0126 certifies the cause of death as acute fentanyl, cocaine, and methamphetamine intoxication and the manner as undetermined. The examiner classified the thermal injuries as postmortem, found no significant antemortem trauma, and stated that foul play could not be excluded. Identification was confirmed by fingerprint. The woman who found Nicoleta said she walked the area daily and that the body was not there on the afternoon of January 31; it was discovered at approximately 11:30 a.m. on February 1. This narrows when the body appeared at the recovery location, not when Nicoleta died. PCSO continues to list case 240201123 with the Cold Case Unit. A separate ME property sheet has been requested.</p><a href="https://www.pinal.gov/1867/Cold-Cases" target="_blank" rel="noreferrer">Pinal County Sheriff official cold-case listing ↗</a></article>');
    }
    ...
    cards.sort((a, b) => {
      ...
      if (aTitle === 'Walter A. Mosier') return -1;
      if (bTitle === 'Walter A. Mosier') return 1;
  ...
  if (recordsGrid && !Array.from(recordsGrid.querySelectorAll('h3')).some((heading) => heading.textContent.trim() === 'Nicoleta Hamlett')) {
    recordsGrid.insertAdjacentHTML('afterbegin', '<article><span>07</span><h3>Nicoleta Hamlett</h3><p>Pinal County Medical Examiner redacted examination and toxicology packet 24-0126, received August 12, 2026. The report certifies acute fentanyl, cocaine, and methamphetamine intoxication as the cause of death and classifies the manner as undetermined. Open Case Ledger summarizes the relevant findings but does not republish the packet because it contains detailed medical, graphic, and sensitive material unnecessary to the public case record. The separately documented ME property sheet has been requested and remains pending.</p><a href="https://www.pinal.gov/1867/Cold-Cases" target="_blank" rel="noreferrer">Pinal County Sheriff official case listing ↗</a></article>');
  }

  if (recordsGrid && !Array.from(recordsGrid.querySelectorAll('h3')).some((heading) => heading.textContent.trim() === 'Wanda Line · final coroner packet')) {
    recordsGrid.insertAdjacentHTML('afterbegin', '<article><span>08</span><h3>Wanda Line · final coroner packet</h3><p>Franklin County Coroner case C84-25, including the coroner report, autopsy report, and toxicology analysis, received August 12, 2026. The final medical certification rules the death a homicide caused by blunt impacts to the head with skull fractures and brain contusions, superseding the preliminary apparent-gunshot scene notation. The packet also documents a vaginal swab containing sperm; oral and rectal swabs were negative. That finding alone does not establish sexual assault or identify an assailant. The raw scans are preserved privately and are not republished because they contain personal identifiers and sensitive autopsy detail.</p><a href="https://www.ohioattorneygeneral.gov/Files/Law-Enforcement/Investigator/Cold-Case/Homicides/Line" target="_blank" rel="noreferrer">Ohio Attorney General cold-case page ↗</a></article>');
  }
  ...
  addResearchNote('Walter A. Mosier · current forensic status', '<article><span>16</span><h3>Walter A. Mosier · current forensic status</h3><p>Open Case Ledger asked whether testing in Franklin County case 2007-3332 had produced a usable non-victim DNA profile suitable for forensic comparison. On August 14, 2026, Captain Charles W. Subke replied that no usable DNA had been produced yet and that he was still submitting evidence. This answers the present usable-profile question. It does not identify the evidence being submitted, the testing methods or laboratory, or whether any particular item remains suitable for future testing. It does establish that evidence submission and forensic work are continuing. No immediate second question is being sent.</p><p class="case-note">Source: Captain Charles W. Subke, Franklin County Sheriff’s Office, direct email correspondence to Open Case Ledger, August 14, 2026. FBI baseline: ViCAP alert 2026-07-10, released July 24, 2026.</p><a href="cases/walter-a-mosier.html">Walter A. Mosier case page ↗</a><br><a href="https://www.fbi.gov/wanted/vicap/homicides-and-sexual-assaults/walter-a-mosier---seneca-missouri/mosier.pdf" target="_blank" rel="noreferrer">FBI ViCAP official alert ↗</a></article>');

  addResearchNote('Wanda Line · final coroner findings', '<article><span>15</span><h3>Wanda Line · final coroner findings</h3><p>Franklin County Coroner case C84-25 resolves the longstanding injury discrepancy. The final February 29, 1984 supplemental certification classifies Wanda’s death as homicide and attributes it to blunt impacts to the head with skull fractures and brain contusions. It says the victim was allegedly beaten. The earlier apparent-gunshot wording was a preliminary scene or intake impression, not the final medical finding. The autopsy also documents blunt impacts to the trunk and extremities. A vaginal swab contained sperm; oral and rectal swabs were negative. That finding alone does not establish sexual assault or identify an assailant. The packet’s only toxicology result is a tranquilizer, sedative, and hypnotics analysis in which no agents were detected. The next primary-source question is whether the documented swab, slides, or related specimens still exist and, if not, where custody transferred or when they were destroyed.</p><p class="case-note">Source: Franklin County Coroner report, autopsy report, and toxicology analysis, case C84-25, received directly from the Coroner’s Office on August 12, 2026. The raw scans are preserved privately and are not republished because they contain personal identifiers and sensitive autopsy detail.</p><a href="https://www.ohioattorneygeneral.gov/Files/Law-Enforcement/Investigator/Cold-Case/Homicides/Line" target="_blank" rel="noreferrer">Ohio Attorney General cold-case page ↗</a><br><a href="documents/wanda-line-fcso-redacted-incident-report-2026-08-07.html">FCSO redacted incident record ↗</a></article>');

  addResearchNote('Nicoleta Hamlett · official ME findings', '<article><span>14</span><h3>Nicoleta Hamlett · official ME findings</h3><p>Pinal County Medical Examiner report 24-0126 certifies the cause of death as acute fentanyl, cocaine, and methamphetamine intoxication and the manner as undetermined. The thermal injuries were classified as postmortem, no significant antemortem trauma was identified, and the examiner stated that foul play could not be excluded. Identification was confirmed by fingerprint. The finder reported walking the desert area daily and said the body was not there on the afternoon of January 31, 2024; it was discovered at approximately 11:30 a.m. February 1. This evidence narrows when the body appeared at the recovery site, not the time of death. PCSO continues to list case 240201123 through its Cold Case Unit with the suspect unknown. The ME packet uses Nicoletta, while the PCSO victim heading uses Nicoleta; this site follows the PCSO heading and preserves Nicoletta as an official-record spelling variant. A separate property sheet documented in the ME file has been requested.</p><p class="case-note">Source: Pinal County Medical Examiner redacted examination and toxicology packet 24-0126, received August 12, 2026. The full packet is preserved in the project archive and is not republished because it contains unnecessary graphic and sensitive medical detail.</p><a href="https://www.pinal.gov/1867/Cold-Cases" target="_blank" rel="noreferrer">Pinal County Sheriff official cold-case listing ↗</a></article>');

  addResearchNote('Wanda Line · January 1984 contemporaneous report', '<article><span>13</span><h3>Wanda Line · January 1984 contemporaneous report</h3><p>A full January 5, 1984 <em>Columbus Dispatch</em> clipping supplied by Columbus Metropolitan Library materially narrows the injury discrepancy in Wanda Line’s homicide. Detectives told the newspaper that Wanda had suffered a severe skull fracture that could have been caused by a blunt instrument such as a hammer. That account, published two days after she was found, is consistent with the Ohio Attorney General’s later description that she was beaten to death and indicates that the Franklin County Sheriff’s scene notation of apparent gunshot wounds was preliminary. The article also says detectives believed Wanda used the alias “Brandy” and worked as a dancer at Looking Kool, 5960 W. Broad St.; the club manager denied that employment claim. Deputies discovered Wanda at 100 Darien Ave., Apt. A after a loud-music complaint. The apartment was locked and chained, her boyfriend Thomas Wessels was reported to be in Florida, detectives said they had identified no motive, and Coroner William Adrion estimated she had been dead about 24 hours. The final coroner and autopsy packet received August 12, 2026 now supplies the controlling medical wording and is summarized in the newer research note above.</p><p class="case-note">Source: “Officers say victim was dancer,” <em>Columbus Dispatch</em>, January 5, 1984, p. 12; copy supplied by Columbus Metropolitan Library, August 8, 2026.</p><a href="https://digital-collections.columbuslibrary.org/digital/collection/p16802coll35/id/398718/" target="_blank" rel="noreferrer">Columbus Metropolitan Library newspaper index ↗</a><br><a href="https://www.ohioattorneygeneral.gov/Files/Law-Enforcement/Investigator/Cold-Case/Homicides/Line" target="_blank" rel="noreferrer">Ohio Attorney General cold-case page ↗</a><br><a href="documents/wanda-line-fcso-redacted-incident-report-2026-08-07.html" target="_blank" rel="noreferrer">FCSO redacted incident record ↗</a></article>');
