(() => {
  ...
  if (researchGrid && !Array.from(researchGrid.querySelectorAll('h3')).some((heading) => heading.textContent.trim() === 'North Port John Doe · official baseline')) {
    researchGrid.insertAdjacentHTML('afterbegin', `
      <article><span>07</span><h3>North Port John Doe · official baseline</h3><p>FBI ViCAP remains the current public identification baseline for the unidentified man recovered in North Port on January 1, 1996. The federal notice describes the recovery circumstances, physical profile, absence of clothing or personal effects, and the later DNA-based ancestry statement. North Port Police’s official records page confirms the department as the direct public-records contact. Open Case Ledger is seeking the original recovery report and any segregable public supplemental material that can clarify the local identification history.</p><a href="https://www.fbi.gov/wanted/vicap/unidentified-persons/john-doe---north-port-florida" target="_blank" rel="noreferrer">FBI ViCAP official source ↗</a><br><a href="https://www.northportfl.gov/City-Services-and-Safety/Emergency-Services/Police/Records" target="_blank" rel="noreferrer">North Port Police records source ↗</a></article>
    `);
  }
